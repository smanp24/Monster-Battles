...
class EffectivenessCalculator:
    ...
    def get_effectiveness(cls, type1: Element, type2: Element) -> float:
        ...
        self_index = cls.instance.element_names.index(type1.name.capitalize())
        other_index = cls.instance.element_names.index(type2.name.capitalize())
        effective_number = self_index * n + other_index
        return cls.instance.effectiveness_value[effective_number]
